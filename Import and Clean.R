...
setwd("C:/Users/DELL/Desktop/bda kills me")
...
for(symbol in sp500$Ticker){
  print(symbol) #https://query1.finance.yahoo.com/v7/finance/download/AAPL?period1=1382140800&period2=1697673600&interval=1d&events=history&includeAdjustedClose=true
  url <- paste0("https://query1.finance.yahoo.com/v7/finance/download/", symbol, "?period1=1382140800&period2=1697673600&interval=1d&events=history&includeAdjustedClose=true")
  print(url)
